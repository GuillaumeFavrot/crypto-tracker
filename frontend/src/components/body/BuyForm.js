            ...
            <form onSubmit={(e) => {onSubmit(e)}}className="h-100 d-flex flex-column justify-content-between">
                <div>
                    <div className="mb-5 d-flex align-items-center">
                        <select className="bg-black border-secondary form-control ps-5 pt-3 pb-3 text-white" placeholder="Sélectionner une crypto" id="token" aria-describedby="token">
                            <option >Sélectionnez une crypto</option>
                            <option name="BTC">BTC (Bitcoin)</option>
                            <option name="ETC">ETC (Ethereum)</option>
                            <option name="XRP">XRP (Ripple)</option>
                        </select>
                    ...
                    <div className="mb-5 d-flex align-items-center">
                        <input type="number" min="0" step="0.001" className="bg-black border-secondary form-control ps-5 pt-3 pb-3 text-white" placeholder="Quantité" id="quantity" aria-describedby="quantity"></input>
                        <i className="position-fixed ms-3">
                    ...
                    <div className="mb-5 d-flex align-items-center">
                        <input type="number" min="0" step="0.01" className="bg-black border-secondary form-control ps-5 pt-3 pb-3  text-white" placeholder="Prix d'achat" id="price" aria-describedby="price"></input>
                        <i className="position-fixed ms-3">
